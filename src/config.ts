...
export const SIRI_SUBSCRIPTION_TTL_MINUTES = envNumber("SIRI_SUBSCRIPTION_TTL_MINUTES", 6 * 60);
export const SIRI_SUBSCRIPTION_RENEWAL_MINUTES = envNumber("SIRI_SUBSCRIPTION_RENEWAL_MINUTES", 10);
export const SIRI_SUBSCRIPTION_HEARTBEAT_TIMEOUT_SECONDS = envNumber("SIRI_SUBSCRIPTION_HEARTBEAT_TIMEOUT_SECONDS", 60);
export const SIRI_ET_POLL_INTERVAL_MS = envNumber("SIRI_ET_POLL_INTERVAL_MS", 3000);
