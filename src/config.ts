...
export const SIRI_SUBSCRIPTION_TTL_MINUTES = envNumber("SIRI_SUBSCRIPTION_TTL_MINUTES", 10);
export const SIRI_SUBSCRIPTION_RENEWAL_MINUTES = envNumber("SIRI_SUBSCRIPTION_RENEWAL_MINUTES", 5);
